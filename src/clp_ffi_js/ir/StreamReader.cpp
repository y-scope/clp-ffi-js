...
EMSCRIPTEN_BINDINGS(ClpStreamReader) {
    ...
    emscripten::register_type<clp_ffi_js::ir::ReaderOption>(
            "{isAutoGenerated: boolean; parts: string[]}"
    );
    emscripten::register_type<clp_ffi_js::ir::ReaderOptions>(
            "{logLevelKey: clp_ffi_js::ir::ReaderOption | null;"
            " timestampKey: clp_ffi_js::ir::ReaderOption | null"
    );
